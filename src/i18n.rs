...
pub fn t_in(lang: Lang, key: &str) -> &'static str {
    match (lang, key) {
        ...
        (Lang::En, "theme-hint") => "Changes apply immediately and are saved to roadmap.json.",
        (Lang::Zh, "theme-hint") => "更改立即生效并保存到 roadmap.json。",
        (Lang::En, "lang-label") => "Language",
        (Lang::Zh, "lang-label") => "语言",
        (Lang::En, "lang-hint") => "Changes apply immediately and are saved to roadmap.json.",
        (Lang::Zh, "lang-hint") => "更改立即生效并保存到 roadmap.json。",
